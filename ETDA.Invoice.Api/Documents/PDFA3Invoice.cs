...
namespace ETDA.Invoice.Api.Documents
{
    public class PDFA3Invoice
    {
        public void CreatePDFA3Invoice(string pdfFilePath, string xmlFilePath, string xmlFileName,
            string xmlVersion, string documentID, string documentOID, string outputPath, string documentType, string icmPath, string xmpSchemaPath)
        {
            ...
            ICC_Profile icc = ICC_Profile.GetInstance(icmPath);
            ...
            string stringExchangeXMP = File.ReadAllText(xmpSchemaPath);
